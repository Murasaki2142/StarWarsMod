...
public class StarWarsPathOfTheJediModItems {
	...
	public static final RegistryObject<Item> CONSOLE = REGISTRY.register(StarWarsPathOfTheJediModBlocks.CONSOLE.getId().getPath(), () -> new ConsoleDisplayItem(StarWarsPathOfTheJediModBlocks.CONSOLE.get(), new Item.Properties()));
